...
import { FaArrowRight, FaComputer, FaDolly } from "react-icons/fa6";
...
function LandingPage() {
  ...
  const catList = useSelector((store) => {
    console.log(store);
  });
  // listener
  // allCatList
  ...
  return (
    <>
      ...
      <section className="bg-gray-50 py-8 antialiased dark:bg-gray-900 md:py-16">
        <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
          ...
          <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            ...
            <a
              href="/category/collectibles-toys"
              className="flex items-center rounded-lg border border-gray-200 bg-white px-4 py-2 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700"
            >
              <FaDolly className="me-2"></FaDolly>
              <span className="text-sm font-medium text-gray-900 dark:text-white">
                Collectibles &amp; Toys
              </span>
            </a>
      ...
      <section className="bg-primary-50 py-8 antialiased dark:bg-gray-900 md:py-16">
        <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
          <div className="mb-4 flex items-center justify-between gap-4 md:mb-8">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl">
              Just for you
