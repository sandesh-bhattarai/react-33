...
import { FaDollarSign, FaImage, FaShoppingBag, FaShoppingCart, FaSitemap } from "react-icons/fa";
        ...
        <nav className="bg-white border-b border-gray-200 px-4 py-2.5 fixed left-0 right-0 top-0 z-50">
            <div className="flex flex-wrap justify-between items-center">
                <div className="flex justify-start items-center">
                    ...
                    <NavLink to='/admin' className="flex items-center justify-between mr-4" style={{textDecoration: 'none'}}>
                        <Avatar
                            img={logo}
                            alt="Logo"
                            className="mr-3 h-8"
