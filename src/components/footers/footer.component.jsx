const HomeFooter = () => {
	return (
		<>
			<footer className="p-4 bg-white md:p-8 lg:p-10 dark:bg-primary-800">
				<div className="mx-auto max-w-screen-xl text-center">
					<a
						href="#"
						className="flex justify-center items-center text-2xl font-semibold text-primary-900 dark:text-white"
					>
					...
					<p className="my-6 text-primary-500 dark:text-primary-400">
						Open-source library of over 400+ web components and interactive elements built for better web.
					</p>
					<ul className="flex flex-wrap justify-center items-center mb-6 text-primary-900 dark:text-white">
						<li>
					...
					<span className="text-sm text-primary-500 sm:text-center dark:text-primary-400">
						© 2021-2022{" "}
